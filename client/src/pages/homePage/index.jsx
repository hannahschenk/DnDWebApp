            ...
            <section className = "character">
                <div className = "character__container1">
                    <div className = "container1__container">
                        ...
                        <p className = "container__text">Creating a character has never been easier with the help of D&D CC. This character creation tool has been
                            simplified to a process where we walk you through each step. <br></br><br></br>This sheet will take you through the race, classes,
                            ability scores, character details, proficiencies, and equipment for the character you want tp create.<br></br><br></br> By creating your character anonymously, you will not be
                    ...
                    <div className = "container__container2">
                        <div className = "container2__textContainer">
                            ...
                            <p className = "textContainer__text">Creating a character under an authenticated account will not only allow you to save your created character,
                                but to also save multiple character sheets. These can be accessed at any time, and edited later.
                            </p>
                            <br></br>
                        </div>
                    </div>
